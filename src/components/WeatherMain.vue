      ...
      <div class="date-container">
        ...
        <transition mode="out-in">
          ...
          <p v-else-if="TheWeatherDataIsLoaded === 200">
            ...
            {{ WeatherDataUpdatedAtATimeComputed < 3 ? '刚刚更新' : `${WeatherDataUpdatedAtATimeComputed}分钟前更新` }} </p>
...
const { dayDateCity, FourDayWeatherData, nowWeatherData, WeatherDataUpdatedAtATimeComputed, TheWeatherDataIsLoaded } = storeToRefs(weatherStore)
const { getLocationInformation, getFourDayWeatherData, getRealTimeWeather, ReviseState } = weatherStore
